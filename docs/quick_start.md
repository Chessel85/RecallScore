# Recall Score Quick Start Guide 

* Download the installer from <https://chessel85.github.io/RecallScore/web_page> and run Recall Score
* From the File menu, select Open and load files of type music XML (musicxml, mxl), MuseScore (mscz), Guitar Pro (GP and GPx) and midi (mid).
...
* Attributes list. Extra information about each note selected in the note list.
* Performance Information. Information on how to perform the piece based on the current position within the score e.g. Repeat bars.
* Use keyboard quick navigation keys of Z, X, C, V and B to jump to any area.
...
* Muted notes are not displayed in the note list.  Soloed notes are always shown in the notes list overriding a mute.
* Alt+F8 and alt+F9 unmute and unsolo all.

Explore the File, Parts, Playback, Options, tools and Help menus for more features.

Full details are in the [Recall Score User Guide](user_guide.html).