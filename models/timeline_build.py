...
class TimelineBuild:
    ...
    # P2: named song jump points (Intro/Verse/Chorus/...). UG and GP
    # populate this; MusicXML and MIDI stub it empty (MusicXML's equivalent,
    # <rehearsal> marks, is a first-class DirectionMark kind already - see
    # models/jump_point.py).
    jump_points: List[Any] = field(default_factory=list)
    ...
    def from_builder(cls, builder) -> "TimelineBuild":
        ...
        return cls(
            ...
            jump_points=builder.jump_points,
    ...
    def apply_to(self, music_data) -> None:
        ...
        music_data.jump_points = self.jump_points
