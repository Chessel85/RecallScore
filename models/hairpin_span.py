...
class HairpinSpan:
    ...
    #           with nothing open (its kind is unknowable)
    start_measure: int
    ...
    # Provenance, all defaulted so the positional construction in existing
    # tests still works. Hairpins are collected in the per-part
