...
datas = [
    ...
    # with `pandoc docs/user_guide.md -s --metadata pagetitle="Recall Score
    # User Guide" -o docs/user_guide.html` whenever the .md source changes
    # (pagetitle, not title, and no --toc - see docs/packaging.md for why);
    # opened from the Help menu (main_window.py
    # user_guide_html_path()/_show_user_guide).
    (os.path.join(REPO_ROOT, "docs", "user_guide.html"), "docs"),
    # Checked into git, regenerated by hand with `pandoc docs/quick_start.md
    # -s --metadata pagetitle="Recall Score Quick Start Guide" -o
    # docs/quick_start.html` whenever the .md source changes; opened from
    # the Help menu (main_window.py quick_start_html_path()/_show_quick_start).
    (os.path.join(REPO_ROOT, "docs", "quick_start.html"), "docs"),
    # Checked into git, regenerated by hand with `pandoc docs/keystrokes.md
    # -s --metadata pagetitle="Recall Score Keyboard Shortcuts" -o
    # docs/keystrokes.html` whenever the .md source changes; opened from
    # the Help menu (main_window.py keystrokes_html_path()/_show_keystrokes).
    (os.path.join(REPO_ROOT, "docs", "keystrokes.html"), "docs"),
