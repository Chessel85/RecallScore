...
datas = [
    ...
    # -s --metadata title="Recall Score Quick Start Guide" -o
    # docs/quick_start.html` whenever the .md source changes (no --toc -
    # too short to need one, and it'd just add a screen-reader landmark
    # with nothing to navigate to); opened from
